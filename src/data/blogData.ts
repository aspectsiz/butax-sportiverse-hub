...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `
        <h2 class="text-xl mt-0">How to deploy your Next.js apps on Vercel.</h2>
        <hr class="my-4">
        ...
        <img alt="Image" loading="lazy" width="718" height="404" decoding="async" data-nimg="1" srcset="/_next/image?url=%2Fblog-post-4.jpg&w=750&q=75 1x, /_next/image?url=%2Fblog-post-4.jpg&w=1920&q=75 2x" src="/_next/image?url=%2Fblog-post-4.jpg&w=1920&q=75" style="color: transparent;">
        ...
        <p>The most annoying thing about lists in Markdown is that </p>
        ...
        <h3>Sometimes I even use  in headings</h3>
        ...
        <p>We don't style them at all out of the box because elements are already so small that they are the same size as the body copy. What are we supposed to do with an <code>h5</code>, make it <em>smaller</em> than the body copy? No thanks.</p>
        <h3>We still need to think about stacked headings though.</h3>
        <h4>Let's make sure we don't screw that up with elements, either.</h4>
    ...
    authorAvatar: '/assets/ahmet-yilmaz-avatar.jpg',
