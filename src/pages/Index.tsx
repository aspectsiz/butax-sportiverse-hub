...
const Index = () => {
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="hero-pattern pt-24 pb-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2">Urban Furniture</h3>
              <p className="text-gray-600">Modern, functional furniture designed for urban spaces.</p>
            </div>
            <div className="text-center p-6">
              <div className="w-12 h-12 mx-auto mb-4 bg-primary/5 rounded-full flex items-center justify-center">
                <Users className="h-6 w-6 text-accent" />
              </div>
              <h3 className="text-xl font-semibold mb-2">Franchise Network</h3>
              <p className="text-gray-600">Join our growing network of successful fitness franchises.</p>
            </div>
          </div>
        </div>
      </section>
