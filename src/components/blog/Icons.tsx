...
export const PauseCircleIcon: React.FC<IconProps> = ({ size = 24, width, height, className, ...props }) => {
  return (
    <svg
      aria-hidden="true"
      fill="none"
...
export const NextIcon: React.FC<IconProps> = ({ size = 24, width, height, className, ...props }) => {
  return (
    <svg
      aria-hidden="true"
      fill="none"
...
export const PreviousIcon: React.FC<IconProps> = ({ size = 24, width, height, className, ...props }) => {
  return (
    <svg
      aria-hidden="true"
      fill="none"
...
export const RepeatOneIcon: React.FC<IconProps> = ({ size = 24, width, height, className, ...props }) => {
  return (
    <svg
      aria-hidden="true"
      fill="none"
...
export const ShuffleIcon: React.FC<IconProps> = ({ size = 24, width, height, className, ...props }) => {
  return (
    <svg
      aria-hidden="true"
      fill="none"
